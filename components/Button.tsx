...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    outline: "border border-gray-300 bg-white text-slate-700 hover:bg-gray-50 focus:ring-slate-900",
    ghost: "bg-transparent text-slate-700 hover:bg-gray-100 focus:ring-gray-500"
  };
